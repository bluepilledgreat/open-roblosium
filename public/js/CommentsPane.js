...
Roblox.CommentsPane = function() {
    var o = function(n) {
        ...
        e = function(n) {
            n == "01" ? Roblox.GenericConfirmation.open({
        ...
        c = function(n) {
            ...
            n = n == undefined ? 0 : n, u = $(".Comments").attr("data-asset-id"), i = $(".Comments"), i.find(".empty,.more").remove(), i.append($('<div class="loading"></div>')), r = Math.floor(Math.random() * 9001), $.ajax({
                ...
                success: function(n) {
                    ...
                    f.length == 0 && i.append($('<div class="empty"' + Roblox.CommentsPane.Resources.noCommentsFound + "</div>")), r = $(".Comments .Comment").length, r < n.totalCount && (u = $('<div class="more"><span class="btn-control btn-control-small">' + Roblox.CommentsPane.Resources.moreComments + "</span></div>"), u.find("span").click(function() {
                        Roblox.CommentsPane.getComments(r)
                    }), i.append(u)), Roblox.require("Widgets.AvatarImage", function(n) {
                        n.populate()
                ...
                error: function() {
                    $(".Comments").find(".loading,.empty,.more").remove().append($('<div class="empty">' + Roblox.CommentsPane.Resources.sorrySomethingWentWrong + "</div>"))
                }
            })
        },
        h = function(n, t, i) {
        ...
        n = function(n, t, i, r) {
            r = typeof r == "undefined" ? !1 : r, i = typeof i == "undefined" ? !0 : i, r && n.empty(), n.append(t + " "), i ? n.hide() : n.show()
        },
        f = function(n, t) {
        ...
        u = function() {
            ...
            $(".AjaxCommentsContainer textarea").on("input propertychange", function() {
                var u = $(".AjaxCommentsContainer textarea")[0],
                    ...
                    t;
                for (n(e, "", !0, !0), t = 0; t < i.length; ++t) h(u.value, i[t].limit, i[t].character) || (u.value = r(u.value, i[t].limit, i[t].character), n(e, i[t].message, !1)), typeof i[t].character == "undefined" && f(u.value, i[t].limit)
            });
            $(".AjaxCommentsContainer .roblox-comment-button").click(function() {
                var t = $(".AjaxCommentsContainer textarea").val();
                if (t != "" && t != " " && t != "Write a comment!" && t != Roblox.CommentsPane.Resources.floodCheckString + $("#AjaxCommentsPaneData").attr("data-comments-floodcheck") + Roblox.CommentsPane.Resources.seconds) {
                    if (Roblox.CommentsPane.FilterIsEnabled && i(t)) {
                        Roblox.GenericModal.open(Roblox.CommentsPane.Resources.linksNotAllowedTitle, "/images/Icons/img-alert.png", Roblox.CommentsPane.Resources.linksNotAllowedMessage);
                        return
                    }
