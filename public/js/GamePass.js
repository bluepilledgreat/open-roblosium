...
Roblox.GamePass = function() {
    ...
    function n(n) {
        ...
        Roblox.require("Widgets.ItemImage", function(n) {
            ...
            i.hasClass("robux") ? t.find(".PurchaseButton").attr("data-expected-currency", 1).attr("data-expected-price", t.find(".Price.robux").text()) : t.find(".PurchaseButton").attr("data-expected-currency", 2).attr("data-expected-price", t.find(".Price.tickets").text())
        })
    }
    return {
        getGamePasses: t,
        formatGamePassHTML: i,
        FormatGamePassCallback: n
    }
}();