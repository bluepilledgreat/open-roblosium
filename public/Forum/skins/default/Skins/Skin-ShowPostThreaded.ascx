...
<table cellPadding="0" width="100%">
  ...
  <tr>
	...
	<span class="normalTextSmallBold"><asp:CheckBox runat="server" id="TrackThread" Text="有回复时给我发邮件"/></span>
    </td>
    <td vAlign="bottom" align="right"><span class="normalTextSmallBold">显示方式 </span><asp:dropdownlist id="DisplayMode" Runat="server">
