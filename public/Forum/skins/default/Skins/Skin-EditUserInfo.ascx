...
<table class="tableBorder" cellSpacing="1" cellPadding="0" width="100%">
	<tr>
		<th class="tableHeaderText" align="left" height="20">
			&nbsp; 编辑用户“<asp:label id="Username" runat="server"></asp:label>”的个人信息</th></tr>
	<tr>
		<td class="forumHeaderBackgroundAlternate" align="left" height="20"><span class="forumTitle">&nbsp;注册信息 </span></td>
	</tr>
	<tr>
		<td class="forumRow">
			<table cellSpacing="0" cellPadding="2" border="0">
				...
				<tr>
					<td colSpan="2"></td>
					<td vAlign="top" height="20"><span class="normalTextSmaller">&nbsp;请填写你的私人信箱.</span></td>
				...
				<tr>
					...
					<td noWrap align="right"><span class="normalTextSmallBold">时区: </span></td>
				...
				<tr>
					<td colSpan="2"></td>
					<td vAlign="top" height="20"><span class="normalTextSmaller">&nbsp;日期和时间会根据你选择的时区显示.</span></td>
				</tr>
				<!-- Date Format -->
				<tr>
					<td class="forumRow" noWrap width="19">&nbsp; &nbsp;
					</td>
					<td noWrap align="right"><span class="normalTextSmallBold">日期格式: </span></td>
				...
				<tr>
					<td colSpan="2"></td>
					<td vAlign="top" height="20"><span class="normalTextSmaller">&nbsp;日期和时间会根据你选择的格式显示.</span></td>
				</tr>
				<!-- Change Password-->
				<tr>
					<td class="forumRow" noWrap width="19">&nbsp; &nbsp;
					...
					<td align="left"><a Class="linkSmallBold" href="<% =Globals.UrlChangePassword %>">修改密码</a></td>
					<td align="left"></td>
				</tr>
			</table>
		</td>
	...
	<tr>
		<td class="forumHeaderBackgroundAlternate" align="left" height="20"><span class="forumTitle"> &nbsp;基本信息 (可选) </span></td>
	</tr>
	<tr>
		<td class="forumRow">
			<table cellSpacing="0" cellPadding="3" width="100%" border="0">
				...
				<tr>
					...
					<!-- Occupation -->
					<td align="right"><span class="normalTextSmallBold">职业: </span></td>
					<td align="left"><asp:textbox id="Occupation" runat="server" columns="35"></asp:textbox></td>
					<td align="left"></td>
					<!-- Location -->
					<td noWrap align="right"><span class="normalTextSmallBold">地区: </span></td>
				...
				<tr>
					...
					<!-- Interests -->
					<td align="right"><span class="normalTextSmallBold">兴趣: </span></td>
				...
				<tr>
					...
					<td align="left"></td>
					<!-- Web site -->
					<td noWrap align="right"><span class="normalTextSmallBold">主页: </span></td>
	...
	<TR>
		<td class="forumHeaderBackgroundAlternate" align="left" height="20"><span class="forumTitle"> &nbsp;显示选项 </span></td>
	</TR>
	<tr>
		<td class="forumRow">
			<table cellSpacing="0" cellPadding="3" border="0">
				...
				<tr>
					<td colSpan="2"></td>
					<td vAlign="top" height="20"><span class="normalTextSmaller"> &nbsp;此Email会和你的个人简档一起公开.</span></td>
				</tr>
				<!-- Signature -->
				<tr>
					<td class="forumRow" noWrap width="19">&nbsp; &nbsp;
					</td>
					<td vAlign="top" align="right"><span class="normalTextSmallBold">署名: </span></td>
					<td align="left" colSpan="2"><asp:textbox id="Signature" runat="server" columns="50" TextMode="MultiLine" rows="5"></asp:textbox></td>
					<td align="left"></td>
				</tr>
				<tr>
					<td colSpan="2"></td>
					<td vAlign="top" height="20"><span class="normalTextSmaller"> &nbsp;署名将附在你的发表的文章后面.</span></td>
				</tr>
				<!-- Style -->
				<tr>
					<td class="forumRow" noWrap width="19">&nbsp; &nbsp;
					</td>
					<td vAlign="top" align="right"><span class="normalTextSmallBold">风格: </span></td>
				...
				<tr>
					...
					<td vAlign="top" align="right"><span class="normalTextSmallBold">浏览: </span></td>
        ...
        <!-- Icon -->
            ...
            pixels).</span>
				...
				<tr>
					<td colSpan="2">
					<td vAlign="top" align="left"><asp:checkbox id="EmailTracking" runat="server" CssClass="normalTextSmallBold" Text="&nbsp;启动邮件提醒"></asp:checkbox></td>
				</tr>
				<!-- Hide read threads -->
				<tr>
					<td colSpan="2">
					<td vAlign="top" align="left"><asp:checkbox id="UnreadThreadsOnly" runat="server" CssClass="normalTextSmallBold" Text="&nbsp;隐藏读过的文章"></asp:checkbox></td>
				</tr>
				<tr>
					<td colSpan="4">&nbsp;</td>
				</tr>
				...
				<table cellSpacing="0" cellPadding="3" border="0" width="100%">
					...
					<tr>
						<td valign="top" width="50%">
							<span class="normalTextSmallBold">&nbsp;&nbsp; Active Roles:</span><br>
							<br>
							<asp:DataGrid ID="ActiveRoles" Runat="server" Width="100%" AutoGenerateColumns="False" CssClass="tableBorder">
								<Columns>
									<asp:TemplateColumn HeaderText="" HeaderStyle-Height="20" HeaderStyle-CssClass="forumHeaderBackgroundAlternate" ItemStyle-CssClass="forumRow">
										<ItemTemplate>
											<asp:LinkButton CssClass="linkSmallBold" CommandName="RemoveRole" CommandArgument='<%# Container.DataItem %>' Text="Remove User From Role" runat="server" ID="RemoveRoleButton"/>
										</ItemTemplate>
									</asp:TemplateColumn>
						...
						<td valign="top" width="50%">
							<span class="normalTextSmallBold">&nbsp;&nbsp; All Roles:</span><br>
							<br>
							<asp:DataGrid ID="AllRoles" Runat="server" Width="100%" AutoGenerateColumns="False" CssClass="tableBorder">
								<Columns>
									<asp:TemplateColumn HeaderText="" HeaderStyle-Height="20" HeaderStyle-CssClass="forumHeaderBackgroundAlternate" ItemStyle-CssClass="forumRow">
										<ItemTemplate>
											<asp:LinkButton CssClass="linkSmallBold" CommandName="AddRole" CommandArgument='<%# Container.DataItem %>' Text="Add User" runat="server" ID="AddRoleButton"/>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn HeaderStyle-Height="20" HeaderStyle-CssClass="forumHeaderBackgroundAlternate" ItemStyle-CssClass="forumRow">
										<HeaderTemplate>
		...
		<tr>
			<td class="forumRow">
				<table cellSpacing="0" cellPadding="3" border="0">
					...
					<tr>
						<td colSpan="2">
						<td vAlign="top" align="left"><asp:button Runat="server" ID="EmailUserPassword" Text="Email the user his/her password" /></td>
					</tr>
					<tr>
						<td colSpan="4">&nbsp;</td>
					</tr>
...
<span id="Moderation" runat="server" Visible="false">
	<AspNetModeration:ModeratedForums runat="server" ID="ModeratedForums" Mode="ViewForUser" />
</span>
<p>
	<table width="100%" border="0">
		<tr>
			<td valign="top" align="middle">
				...
				<asp:button id="Submit" runat="server" Text="保存修改内容" type="submit"></asp:button>
			</td>
		</tr>
		<tr>
